...
function AboutSection() {
  return (
    ...
    <section className="px-8 pt-4 py-20 bg-white" id="about">
      ...
      <div className="flex items-center gap-12 max-w-7xl mx-auto">
        ...
        <div className="flex-1">
          <p className="w-96 h-96 text-2xl text-gray-700 pt-4 leading-relaxed">
  ...
  <br /> every line is a step forward in my journey.
        ...
        <div className="flex-1">
          <img 
            src={JamesPng} 
            alt="James Eboka" 
            className="w-96 h-96 object-cover rounded-[3rem] mx-auto"
          />
        </div>
